var t,e,r,n,i,o,a,s,l="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function f(t,e,r,n){Object.defineProperty(t,e,{get:r,set:n,enumerable:!0,configurable:!0})}var c={};function p(t,e){return function(){return t.apply(e,arguments)}}t=void 0!==l?l:"undefined"!=typeof window?window:c,e=function(t){// COMMON: SSR check: begin
...
info:function(t,e,n,i,o){c(r.Info,t,e,n,i,o)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Report:p.Report}):{Report:p.Report}},"function"==typeof define&&define.amd?define([],function(){return e(t)}):"object"==typeof c?c=e(t):t.Notiflix=e(t);// utils is a library of generic helper functions non-specific to axios
...
V["-".charCodeAt(0)]=62,V["_".charCodeAt(0)]=63,a=function(t,e,r,n,i){var o,a,s=8*i-n-1,l=(1<<s)-1,f=l>>1,c=-7,p=r?i-1:0,u=r?-1:1,h=t[e+p];for(p+=u,o=h&(1<<-c)-1,h>>=-c,c+=s;c>0;o=256*o+t[e+p],p+=u,c-=8);for(a=o&(1<<-c)-1,o>>=-c,c+=n;c>0;a=256*a+t[e+p],p+=u,c-=8);if(0===o)o=1-f;else{if(o===l)return a?NaN:(h?-1:1)*(1/0);a+=Math.pow(2,n),o-=f}return(h?-1:1)*a*Math.pow(2,o-n)},s=function(t,e,r,n,i,o){var a,s,l,f=8*o-i-1,c=(1<<f)-1,p=c>>1,u=23===i?5960464477539062e-23:0,h=n?0:o-1,m=n?1:-1,d=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=c):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+p>=1?e+=u/l:e+=u*Math.pow(2,1-p),e*l>=2&&(a++,l/=2),a+p>=c?(s=0,a=c):a+p>=1?(s=(e*l-1)*Math.pow(2,i),a+=p):(s=e*Math.pow(2,p-1)*Math.pow(2,i),a=0));i>=8;t[r+h]=255&s,h+=m,s/=256,i-=8);for(a=a<<i|s,f+=i;f>0;t[r+h]=255&a,h+=m,a/=256,f-=8);t[r+h-m]|=128*d};const Z="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
const tk={};function tv(t,e,r){tk[t]=class extends r{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
...
// ================
const tS=/[^+/0-9A-Za-z-_]/g;function tO(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let a=0;a<n;++a){// is surrogate component
...
const tI=function(){let t="0123456789abcdef",e=Array(256);for(let r=0;r<16;++r){let n=16*r;for(let i=0;i<16;++i)e[n+i]=t[r]+t[i]}return e}();// Return not function with Error if BigInt not supported
...
t=tj(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tP=W.toFlatObject(W,{},null,function(t){return/^is[A-Z]/.test(t)});var t_=/**
...
e.data=ee.call(t,t.transformResponse,e),e.headers=et.from(e.headers),e},function(e){return!er(e)&&(ed(t),e&&e.response&&(e.response.data=ee.call(t,t.transformResponse,e.response),e.response.headers=et.from(e.response.headers))),Promise.reject(e)})}const ey=t=>t instanceof et?t.toJSON():t;function eb(t,e){// eslint-disable-next-line no-param-reassign
...
const{Axios:eO,AxiosError:eB,CanceledError:eT,isCancel:eC,CancelToken:eI,VERSION:eL,all:eU,Cancel:ez,isAxiosError:ej,spread:eF,toFormData:eP,AxiosHeaders:e_,HttpStatusCode:eM,formToJSON:eX,getAdapter:eD,mergeConfig:eW}=eS,e$={formEl:document.querySelector(".search-form"),galleryEl:document.querySelector(".gallery"),loadMoreEl:document.querySelector(".load-more")};e$.formEl.addEventListener("submit",function(t){t.preventDefault(),e$.loadMoreEl.classList.add("is-hidden"),eq.query=t.target.elements.searchQuery.value,eq.page=1,eq.getImagesByQuery().then(({data:t})=>{if(console.log(t),0===t.total){e$.galleryEl.innerHTML="",e$.loadMoreEl.classList.add("is-hidden"),e$.formEl.reset(),(0,c.Report).failure("Sorry,","there are no images matching your search query. Please try again.");return}if(1===t.totalHits){e$.galleryEl.innerHTML=eJ(t.hits),e$.loadMoreEl.classList.add("is-hidden"),(0,c.Report).warning("We're sorry,","but you've reached the end of search results.");return}(0,c.Report).success(`Hooray! We found ${t.totalHits} images.`),e$.galleryEl.innerHTML=eJ(t.hits),e$.loadMoreEl.classList.remove("is-hidden")}).catch(t=>{(0,c.Report).failure("err")})}),e$.loadMoreEl.addEventListener("click",function(t){eq.page+=1,eq.getImagesByQuery().then(({data:t})=>{e$.galleryEl.insertAdjacentHTML("beforeend",eJ(t.hits)),t.totalHits===eq.page&&e$.loadMoreEl.classList.add("is-hidden")}).catch(t=>{(0,c.Report).failure("err")})}//# sourceMappingURL=index.a4a39839.js.map
);const eq=new class{constructor(){this.page=1,this.query=null,eS.defaults.baseURL="https://pixabay.com"}getImagesByQuery(){let t={params:{page:this.page,per_page:40,key:"40691933-b7715a41418a5dba6dc83beb8",q:this.query,image_type:"photo",orientation:"horizontal",safesearch:!0}};return eS.get("/api/",t)}};function eH(t){let{webformatURL:e,tags:r,likes:n,views:i,comments:o,downloads:a}=t;return`<div class="photo-card">
...
</div>`}function eJ(t){return t.map(eH).join("")}
//# sourceMappingURL=index.a4a39839.js.map
